...
const Header = () => {
  ...
  return (
    <>
      <div className="bg-white h-fit text-center justify-between align-middle flex pt-5 md:pt-2 pb-2 px-2 md:px-10">
        <div className="flex">
          <Link to="https://www.ibbu.edu.ng" className="flex">
      ...
      {toggle && (
        <div
          className="w-full h-[100vh] bg-black/5 fixed"
          onClick={() => setToggle(false)}
        >
          <div className="flex flex-col w-[25%] relative float-right bg-white">
            <Link
              to="/"
              className={`${
                pathname === "/"
